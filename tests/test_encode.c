...
static void run_rand_u8(Case *c)
{
	...
	uint64_t *input = malloc(input_sz * 8);
	...
	printf(
	    ...
	    (8.0 * nround * input_sz / _1GiB) / (en_ms / 10e3),
	    (8.0 * nround * input_sz / _1GiB) / (de_ms / 10e3),
	    (8.0 * nround * input_sz / _1MiB),
